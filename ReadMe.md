...
GitHubアップローダで使うマスターDBを作成するツール。（他者リポジトリDB追加版）
...
* GitHub.Database.Create.Auto.Add.Languages.refactoring.2017032221114
* GitHub.Other.Repository.Licenses.Database.Insert.File.201703221147
